        ...
        <asp:ValidationSummary runat="server" CssClass="text-danger" EnableClientScript="False" />
         ...
         <div class="form-group">
             ...
             <div class ="col-md-4">
                 ...
                 <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Account Number is required" ControlToValidate="AccountNumber" EnableClientScript="False" Display="Dynamic" CssClass="text-danger" Text="*"></asp:RequiredFieldValidator>
                 <asp:CustomValidator ID="cvAccountNumber" runat="server" ErrorMessage="CustomValidator" EnableClientScript="False" CssClass="text-danger" Display="Dynamic" Text="*" ControlToValidate="AccountNumber" OnServerValidate="cvAccountNumber_ServerValidate"></asp:CustomValidator> 
             </div>
             <asp:Label runat="server" AssociatedControlID="FirstName" Text="First Name" CssClass="control-label col-md-2"></asp:Label>
             <div class ="col-md-4">
                 <asp:TextBox ID="FirstName" runat="server" CssClass="form-control" MaxLength="35">CHIN KIU</asp:TextBox>
                 <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="First Name is required" ControlToValidate="FirstName" CssClass="text-danger" Display="Dynamic" EnableClientScript="False" Text="*"></asp:RequiredFieldValidator>
             </div>
         </div>
         ...
         <div class="form-group">
             ...
             <div class="col-md-4">
                 ...
                 <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="A HKID or Passport number is required" Display="Dynamic" CssClass="text-danger" EnableClientScript="False" ControlToValidate="HKID" Text="*"></asp:RequiredFieldValidator>
             </div>
             <asp:Label runat="server" AssociatedControlID="LastName" Text="Last Name " CssClass="control-label col-md-2"></asp:Label>
             <div class ="col-md-4">
                 <asp:TextBox ID="LastName" runat="server" CssClass="form-control" MaxLength="35">KWAN</asp:TextBox>
                 <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Last Name is required" ControlToValidate="LastName" EnableClientScript="False" Display="Dynamic" CssClass="text-danger" Text="*"></asp:RequiredFieldValidator>
             </div>
         </div>
         ...
         <div class="form-group">
             ...
             <div class ="col-md-4">
                 <asp:TextBox ID="Email" runat="server" TextMode="Email" CssClass="form-control" MaxLength="30">ckkwanaa@ust.hk</asp:TextBox> 
                 <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="Email is required" Display="Dynamic" CssClass="text-danger" Text="*" EnableClientScript="False" ControlToValidate="Email"></asp:RequiredFieldValidator>
             </div>
         </div>
        
         <div class="form-group">
             
             <asp:Label runat="server" AssociatedControlID="Tittle" Text="Tittle" CssClass="control-label col-md-2"></asp:Label> <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ErrorMessage="Tittle is required" Text="*" EnableClientScript="False" ControlToValidate="Tittle" Display="Dynamic" CssClass="text-danger"></asp:RequiredFieldValidator>
             <div>
