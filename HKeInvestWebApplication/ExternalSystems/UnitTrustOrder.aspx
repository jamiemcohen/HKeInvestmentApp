<%@ Page Title="" Language="C#" MasterPageFile="~/ExternalSystems/ExternalSite.Master" AutoEventWireup="true" CodeBehind="UnitTrustOrder.aspx.cs" Inherits="HKeInvestWebApplication.ExternalSystems.UnitTrustOrder" Theme="ExternalSystemsTheme" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h2>Execute Unit Trust Order</h2>
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <div class="col-sm-8">
                <asp:GridView ID="gvUnitTrustBuyOrder" runat="server" CssClass="table table-bordered table-condensed" 
                    AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="referenceNumber" OnRowCommand="gvUnitTrustBuyOrder_RowCommand">
                    <Columns>
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <div class="col-sm-8">
                <asp:GridView ID="gvUnitTrustSellOrder" runat="server" CssClass="table table-bordered table-condensed" 
                    AutoGenerateColumns="False" DataKeyNames="referenceNumber" AllowSorting="True" OnRowCommand="gvUnitTrustSellOrder_RowCommand">
                    <Columns>
                        <asp:ButtonField CommandName="ExecuteOrder" Text="Execute" ButtonType="Button" HeaderText="Action">
                            <ControlStyle CssClass="btn btn-primary btn-sm" Height="30px" Width="70px" />
                            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" Wrap="False" />
